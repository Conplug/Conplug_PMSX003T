...
#include "Conplug_PMSX003T.h"


Conplug_PMSX003T::Conplug_PMSX003T(SoftwareSerial* pPmsSerial)
{
    ...
    DelayValue[Conplug_PMSX003T::AFTER_SEND_PASSIVE_CMD] = 100;
    DelayValue[Conplug_PMSX003T::AFTER_SEND_REQUEST_CMD] = 30;
    DelayValue[Conplug_PMSX003T::SERIAL_READ] = 5;
    
    LastErr = 0;
}

void Conplug_PMSX003T::begin()
{
    //
    // Change mode to passive
    //
    PmsSerial->write(PMS_CMD_PASSIVE_MODE, sizeof(PMS_CMD_PASSIVE_MODE));
    delay(DelayValue[Conplug_PMSX003T::AFTER_SEND_PASSIVE_CMD]);
}

PMS5003T_DATA* Conplug_PMSX003T::readPms() {
    int bi = 0;
    unsigned char c;
    ...
    delay(DelayValue[Conplug_PMSX003T::AFTER_SEND_REQUEST_CMD]); // Wait for PMS5003 to calculate data.
    ...
    while ((millis() - pms_timeout) < 1300) {
        if(PmsSerial->available()) {
            ...
            delay(DelayValue[Conplug_PMSX003T::SERIAL_READ]); // PMS5003T is a slow sensor
        }
    }
...
//
Conplug_PMSX003T::PMS_TYPE Conplug_PMSX003T::readDeviceType()
{
    return DeviceType;
}
...
//
void Conplug_PMSX003T::setDelay(Conplug_PMSX003T::PMS_DELAY PmsDelay, int Value)
{
